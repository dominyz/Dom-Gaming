...
IniRead, Electrocutetimer, Starpact2.ini, Settings, Electrocutetimer
IniRead, Channeltimer, Starpact2.ini, Settings, Channeltimer
IniRead, Refilltimer, Starpact2.ini, Settings, Refilltimer


Loop,% #ctrls 
{
	If (A_Index == 1)
		GUI, Add, Text, xm, Hotkey to hold for Attacking cycle:
	...
	IniRead, savedHK%A_Index%, Starpact2.ini, Hotkeys, %A_Index%, %A_Space%	;Check for saved hotkeys in INI file.
...
IniWrite, %Electrocutetimer%, Starpact2.ini, Settings, Electrocutetimer
GUIControlGet, Channeltimer
IniWrite, %Channeltimer%, Starpact2.ini, Settings, Channeltimer
GUIControlGet, Refilltimer
IniWrite, %Refilltimer%, Starpact2.ini, Settings, Refilltimer
Return
...
setHK(num,INI,GUI) 
{
	...
	IniWrite,% GUI ? GUI:null, Starpact2.ini, Hotkeys, %num%
	savedHK%num%  := HK%num%
}
